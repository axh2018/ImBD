...
do
        ...
        do
                ...
                --output_file=./other_model_results/polish/${BASEMODEL}/${DATASET}_polish_${BASEMODEL} \
...
do
        ...
        do
                ...
                --dataset_file=./data/polish/${BASEMODEL}/${DATASET}_polish_${BASEMODEL}.t5-3b.perturbation_100 \
                --output_file=./other_model_results/polish/${BASEMODEL}/${DATASET}_polish_${BASEMODEL} \
                --scoring_model_name=gpt-neo-2.7B \
                --cache_dir=./models \
                --seed=42 \
