...
do
        ...
        do
                ...
                --dataset_file=./data/generation/${BASEMODEL}/${DATASET}_generation_${BASEMODEL} \
                --output_file=./other_model_results/generation/${BASEMODEL}/${DATASET}_generation_${BASEMODEL} \
...
do
        ...
        do
                ...
                --dataset_file=./data/generation/${BASEMODEL}/${DATASET}_generation_${BASEMODEL}.t5-3b.perturbation_100 \
                --output_file=./other_model_results/generation/${BASEMODEL}/${DATASET}_generation_${BASEMODEL} \
                --scoring_model_name=gpt-neo-2.7B \
                --cache_dir=./models \
                --seed=42 \
